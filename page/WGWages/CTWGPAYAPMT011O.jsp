...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		...
		<table id="table" width="865"  border="1" bordercolor="#6699CC"   cellpadding="0" cellspacing="0">
			...
			<td id="empCode" align="center"><input type="text" name="empCode" readonly="readonly" maxlength="13" style="width:100%" onchange="whenSelectEmpOptionInRow(this);"  onkeyup="if(this.value < 0) this.value = '';if(isNaN(Number(this.value))) this.value = this.value.substring(0,this.value.length - 1);"></td>

...
<script type="text/javascript">
	...
	function whenApToGl()
	{
		...
		(
			...
			workMonth,
			stdDate,
			{callback:whenApToGlHandler,errorHandler:function(message) { alert('เกิดข้อผิดพลาดเกี่ยวกับการติดต่อสื่อสาร apToGl');}}
		);
	}
...
<body>
	<table width="100%">
		<tr>
			<td class="font-head">[ CTWGPAYGL001 ] ส่งข้อมูลค่าจ้าง ลูกจ้างเหมา เข้าระบบ GL ERP กบ.
			</td>
		</tr>
	</table>
	<form name="searchForm" action="" method="post">
			...
			<tr>
				<td><BR />
					<table width="430" border="0" align="center" cellspacing="1">
						...
						<tr>
						<td class="font-field" align="right">วันที่ปิดข้อมูล  ใช้ปี ค.ศ. </td>
		...
		<CENTER>
			<input type="button" class="button" style="width: 80px"
				value="ประมวลผล" name="add" onclick="query();" />
		</CENTER>
	</form>
</body>
</html>

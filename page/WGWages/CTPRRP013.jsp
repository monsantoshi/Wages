...
<script type="text/javascript">
	...
	function onLoadPeriodSection(){
		PrPeriodLineService.findPeriodInPeriodLine(DWRUtil.getValue("ouCode"),DWRUtil.getValue("year"),{callback:onLoadPeriodSectionCallback});
	}
	...
	function onChangePeriodSection(){
		PrPeriodLineService.findPeriodInPeriodLine(DWRUtil.getValue("ouCode"),DWRUtil.getValue("year"),{callback:onChangePeriodSectionCallback});
	}
...
<table width="100%">
<tr>
	<td height="70" align="left" valign="top" class="font-head">[ CTPRRP013 ]  รายงานรายละเอียดจ่ายเงินเดือน รายบุคคล</td>
</tr>
<tr>
<td align="center" valign="middle">
<form action="prAftProcess13Report.htm?reqCode=doPrintReport" method="post" name="mainform"  >

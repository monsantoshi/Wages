...
<table width="100%" >
<tr>
	<td  height="70" align="left" valign="top" class="font-head">[ CTWGPAYAPRPMT003 ] รายงานรับรองข้อมูลค่าล่วงเวลา (ลูกจ้างเหมา) </td>
</tr>
<tr>
	<td height="150" align="center" valign="middle">

<form action="wgpayApPr003Rpt.htm?reqCode=doPrintReport" method="post" name="mainform" target="_blank"  >

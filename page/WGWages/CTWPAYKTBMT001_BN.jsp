...
<%
	...
	//String year = request.getParameter("evaYear")==null?String.valueOf(now.get(Calendar.YEAR)+543):request.getParameter("evaYear");
	//String month = request.getParameter("evaMonth")==null?String.valueOf(now.get(Calendar.MONTH)):request.getParameter("evaMonth");
	//String approve = "";
	...
	//	year =  request.getParameter("evaYear")==null?String.valueOf(now.get(Calendar.YEAR)+543):request.getParameter("evaYear");
	//	month =  request.getParameter("evaMonth")==null?String.valueOf(now.get(Calendar.MONTH)+1):request.getParameter("evaMonth");
		//year =  request.getParameter("hidYear")==null?String.valueOf(now.get(Calendar.YEAR)+543):request.getParameter("hidYear");
		//month =  request.getParameter("hidMonth")==null?String.valueOf(now.get(Calendar.MONTH)):request.getParameter("hidMonth");
		
	//}
%>
<html>
<head>
<title>นำส่งข้อมูลค่าจ้าง ธนาคารกรุงไทย</title>
<!-- Include -->
...
<table width="100%">
	<tr>
		<td class="font-head">
			[ CTWPAYKTBMT001 ] นำส่งข้อมูลค่าจ้าง ธนาคารกรุงไทย
		</td>
	</tr>
</table>
...
function whenShowReport(){
	...
	//forController();
	frm.action="wpKtbReport.htm?reqCode=doPrintReport";
	frm.target = "_blank";
	frm.submit();
	frm.target = "_self";
}

...
<script type="text/javascript">
	...
	function whenEmpBlur()
	{
    	if( '<%=empCode%>' != '' )
    	{
    		...
    		FeeWgPnEmployeeService.findPnEmpDetailInSecue('<%=userId%>', '<%=ouCode%>', '<%=empCode%>', $("year").value, $("period").value,{callback:whenPnEmployeeDeatilCallback});			    	
    	}
    }
	...
	{
		FeeWgPrMonthlyLineService.findPaySlip
		(
			'<%=ouCode%>',
...
<table width="100%">
	<tr>
		<td class="font-head">
			[ CTWGPAYQY001DT02 ] สอบถามข้อมูลประจำเดือนของลูกจ้าง (Pay Slip)
		</td>
	</tr>
</table>
...
<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" class=" button "  value="ข้อมูลหลัก" name="buttonDT01" onclick="gotoCTWGPAYQY001DT01Page();"/>
&nbsp;&nbsp;

...
<html>
<head>
<title>บันทึกรายการหักได้รับค่าจ้างไม่เต็มเดือน</title>
<!-- Include -->
...
<!--
	...
	var rwVinai3 = {keySeq:null, ouCode:null, yearPr:null, periodPr:null,empCode:null,
	...
	function insertNewData()
	{
		 if(compareMonthBeforSave()){
			...
			if(oRows.length > 2)
			{
				...
				{
					rwVinai3.ouCode = '<%=ouCodeInsert%>';
					rwVinai3.yearPr = '<%=yearInsert%>';
					rwVinai3.periodPr = '<%=periodInsert%>';
					rwVinai3.empCode = DWRUtil.getValue("empCbo");
					...
					rwVinai3.approveFlag = 'N';
					rwVinai3.updBy = '<%=userIdInsert%>';
					rwVinai3.creBy = '<%=userIdInsert%>';
					rwVinai3.creDatw = getDateFromFormat(<%=date%>,"dd/MM/yyyy");
					//RwVinai3Service.insertRwVinai3(rwVinai3, {callback:onInsertCallback});
				...
				DWREngine.endBatch();	
				//RwVinai3Service.insertAndUpdate({callback:ClearData});
	 	...
	 	//document.forms['formInsert'].elements['refNo'].focus();
					...
					for(var i=oRows.length-1;i > 1;i--){
								...
								if(yearWork != null && yearWork != '' && periodWork != null && periodWork != '' ){
										...
										if(yearWork > yearInsert && periodWork != null ){
												 	ss = false;
													alert("ตรวจสอบเดือนที่เบิก");
...
<table width="100%">
	<tr>
		<td class="font-head">
			[ CTWPAYIN014 ] บันทึกรายการหักได้รับค่าจ้างไม่เต็มเดือน
		</td>
	</tr>
</table>
				...
				<table id="table"  bordercolor="#4A4A4A" align="center" style="text-align: center;width:750px" border="1" cellpadding="0" cellspacing="0" >
					<thead style="text-align: center">
						<tr CLASS="TABLEBULE2" style="height:30px;">
							...
							<th CLASS="TABLEBULE2" style="width:150px" align="center">ประเภทรายการ</th>
							<th CLASS="TABLEBULE2" colspan="2" align="center">ปี/เดือนที่ทำงาน</th>
							<th CLASS="TABLEBULE2" style="width:150px" align="center"><center>จำนวนวันหัก</center></th>

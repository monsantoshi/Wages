...
<script type="text/javascript">
	...
	function onLoadIncDec(){
		FeeWpayPrIncomeDeductService.findIncDecCodeOutAmtRep(DWRUtil.getValue("ouCode"),1,{callback:onLoadIncDecCallback});
	}
...
<table width="100%" >
<tr>
	<td height="70" align="left" valign="top" class="font-head">[ CTWPAYAPRP001 ]  รายงานข้อมูลรายได้ หลังคำนวน</td>
</tr>
<tr>
<td align="center" valign="middle">
<form action="wpayAftProcess01Report.htm?reqCode=doPrintReport" method="post" name="mainform" target="_blank" >
							...
							<tr>
								...
								<td height="30" colspan="3" >
									<select name="flag" style="width: 233">
						    				...
						    				<option value="R">เรียกคืน</option>

...
<script type="text/javascript">
   ...
   /* function whenFetchEmployeeToCallback(data)
	...
	var feeWpayRwPremium = {keySeq:null, ouCode:null, yearPr:null, periodPr:null,empCode:null,yearWork:null,periodWork:null,codeSeq:null,morDay:null,aftDay:null,evnDay:null,morHour:null,aftHour:null,
					 evnHour:null,amtMor:null,amtAft:null,amtEvn:null,flagPr:null,confirmFlag:null,seqData:null,updBy:null,updDate:null,creBy:null,creDate:null};
	...
	function onUpdate(){
		...
		var num = 3 + parseInt(DWRUtil.getValue("dataLength"));
		...
		if(parseInt(DWRUtil.getValue("dataLength")) != null && parseInt(DWRUtil.getValue("dataLength")) > 0){
			num = 3 + parseInt(DWRUtil.getValue("dataLength"));
		}else{
			num = 3 ;
		}

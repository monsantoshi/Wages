...
<%
	...
	String month = request.getParameter("hidWorkMonth")==null?String.valueOf(now.get(Calendar.MONTH)):request.getParameter("hidWorkMonth");
	String approve = "";
...
<table width="100%">
	<tr>
		<td class="font-head">
			[ CTWGPAYKTBMT001 ] นำส่งข้อมูลค่าจ้างเหมา ธนาคารกรุงไทย
		</td>
	</tr>
</table>
...
function whenShowReport(){
	...
	//forController();
	frm.action="wgKtbReport.htm?reqCode=doPrintReport";
	frm.target = "_blank";
	frm.submit();
	frm.target = "_self";
}

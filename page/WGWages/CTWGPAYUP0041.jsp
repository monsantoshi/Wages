...
<table>
	<tr>
		<td class="font-head">[ CTWGPAYUP0041 ]  แก้ไขจำนวนวันทำงานในแต่ละเดือนของลูกจ้างเหมา</td>
	</tr>
</table>
...
<table width="580" border="0" align="center" cellspacing="1">
	...
	<tr>
		...
		<td><input type="text" name="empCode" size="13" readonly="readonly" style="width: 100;text-align: center;background-color: silver;"/></td>
		<td class="font-field">ชื่อ-นามสกุล</td>
		<td><input type="text" name="empName" size="20" readonly="readonly" style="width: 200;text-align: left;background-color: silver;"/><td>
</table>
<br/>
...
<script>
	...
	function whenClickUpdate(){
		...
		FeeWgPrWorkDayService.updateTaMonthEmpWork(ouCode, workYear, workMonth, empCode, userId, arrDay, arrWorkCode, arrWorkSeq,arrNote, {callback:whenUpdateComplete});
	}

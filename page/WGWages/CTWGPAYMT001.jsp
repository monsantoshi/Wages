...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function chkMainClose(){
				FeeWgPrPeriodLineService.findPeriodLine(
						'<%= ouCode %>',
						$("year").value,
						$("period").value,
								'<%= userId %>',
		    ...
		    function whenQueryEmpBefore(){
				...
				FeeWgPrEmployeeService.findByCriteria(
		     		'<%= ouCode %>', 
		     		$("year").value, 
		     		$("period").value,
		     		'<%= userId %>',
		    ...
		    function countData(){
				...
				FeeWgPrEmployeeService.getCountByCriteria(
		     		'<%= ouCode %>', 
		     		$("year").value, 
		     		$("period").value,
		     		'<%= userId %>',
	...
	<body>
		<table width="100%">
			<tr>
				<td class="font-head">
					[ CTWGPAYMT001 ] บันทึกข้อมูลหลักในการจัดทำค่าจ้าง ลูกจ้างเหมา
				</td>
			</tr>
		</table>
			...
			<table width="750" border="0" align="center" cellspacing="0">
				<tr>
  				...
  				<tr>
    				...
    				<td align="left">
    					<input type="text" Id="empFrom" maxlength="13"  /> 
				    ...
				    <td align="left">
				    	<input type="text" Id="empTo" maxlength="13"  /> 
		...
		<form name="insertForm" action="security.htm?reqCode=CTWGPAYIN001" method="post">
		...
		<form name="editForm" action="security.htm?reqCode=CTWGPAYUP001" method="post">
		...
		<form name="deleteForm" action="security.htm?reqCode=CTWGPAYDL001" method="post">

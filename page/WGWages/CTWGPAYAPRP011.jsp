...
<html>
<head>
<title>Report Other Deduct</title>
...
<script type="text/javascript">
	...
	function onLoadIncDec(){
		FeeWgPrIncomeDeductService.findIncDecCodeRep(DWRUtil.getValue("ouCode"),2,{callback:onLoadIncDecCallback});
	}
...
<table width="100%" >
<tr>
	<td height="70" align="left" valign="top" class="font-head">[ CTWGPAYAPRP011 ]  รายงานรับรองข้อมูลรายหักอื่นๆ (ลูกจ้างเหมา)</td>
</tr>
<tr>
<td align="center" valign="middle">
<form action="wgpayApPr011Rpt.htm?reqCode=doPrintReport" method="post" name="mainform" target="_blank" >
				...
				<tr>
					<td height="150" align="center" valign="middle" >
 						<table width="350" align="center" border="0" cellpadding="2" cellspacing="2">
							...
							<tr>
            					<td class="font-field"  align="right" width="100">ประเภทรายหัก</td>

...
<script type="text/javascript">
	...
	function onLoadIncDec(){
		FeeWpayPrIncomeDeductService.findIncDecCode(DWRUtil.getValue("ouCode"),1,{callback:onLoadIncDecCallback});
	}
...
<table width="100%" >
<tr>
	<td height="70" align="left" valign="top" class="font-head">[ CTWPAYRP008 ]  รายงานข้อมูลรายการรับอื่นๆ (ลูกจ้าง)</td>
</tr>
<tr>
<td align="center" valign="middle">
<form action="wpayPr008Rpt.htm?reqCode=doPrintReport" method="post" name="mainform"  >

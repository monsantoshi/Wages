				...
				if(empNull){
					...
					for(var i=0; i<tab.rows.length; i++){
						...
						if (yearWork[i].value != ''&& yearWork[i].value != null){
							feeWpayRwOvertime.yearWork  = yearWork[i].value;
						}
						else{
							feeWpayRwOvertime.yearWork  = null;
						}
						
						if (periodWork[i].value != '' && periodWork[i].value != null){
							feeWpayRwOvertime.periodWork  = periodWork[i].value;
						}
						else{
							feeWpayRwOvertime.periodWork  = null;
						}
	...
	function insertNewData()
	{
		...
		if(empNull){
			...
			for(var i=oRows.length-1;i > num;i--)
			{
					...
					feeWpayRwOvertime.yearWork = oRows[i].cells["yearWork"].childNodes[0].value;
					feeWpayRwOvertime.periodWork = oRows[i].cells["periodWork"].childNodes[0].value;
					feeWpayRwOvertime.otType = oRows[i].cells["otType"].childNodes[0].value;
...
<table  width="800" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		...
		<table id="table" lign="center" style="text-align: center;width:2200px;"  border="1" bordercolor="#6699CC" cellpadding="0"  cellspacing="0">
			<thead style="text-align: center">
				<tr CLASS="TABLEBULE2" style="height: 30px;">
					...
					<th CLASS="TABLEBULE2" style="width:250px" rowspan="2" colspan="2">สังกัดปฎิบัติงาน</th>
					<th CLASS="TABLEBULE2" style="width:200px" rowspan="2" colspan="2">เลขที่ ล.1</th>
				...
				<tr CLASS="TABLEBULE2"  >
							...
							<th CLASS="TABLEBULE2" style="width:60px"  align="center">3 เท่า </th>
							<th CLASS="TABLEBULE2" style="width:60px"  align="center">1.5 เท่า </th>
							<th CLASS="TABLEBULE2" style="width:60px"  align="center">1 เท่า </th>
							<th CLASS="TABLEBULE2" style="width:60px"  align="center">3 เท่า </th>
			...
			<td id="refNo" align="center" style="width:350px"><input type="text"  name="refNo" readonly="readonly" style="width:80%;background-color:silver;"/><input type="text"  name="refNo" readonly="readonly" style="width:20%;background-color:silver;"/></td>
				    ...
				    if(tab.rows.length>1){
						for(i=0; i<tab.rows.length; i++){
							...
							if (chk[i].checked){
									...
									FeeWpayRwPremiumService.deleteRwPremium(feeWpayRwOvertime, {callback:onDeleteCallback,errorHandler:function(message) { alert('เกิดข้อผิดพลาดเกี่ยวกับการติดต่อสื่อสาร');}});
									chDelete = true;
								}

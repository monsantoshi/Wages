...
<table width="100%" >
<tr>
	<td height="70" align="left" valign="top"  class="font-head">[ CTWPAYRP014 ]  รายงานรายการหักได้รับค่าจ้างไม่เต็มเดือน</td>
</tr>
<tr>
<td align="center" valign="middle">
<form action="wpayPr014Rpt.htm?reqCode=doPrintReport" method="post" name="mainform"  >
		...
		<input type="hidden" name="userId" value="<%=userId%>">
			<table width="470" align="center" cellpadding="2" cellspacing="2"  border="1" bordercolor="#6699CC" >
 			...
 			<table width="350" align="center" border="0" cellpadding="2" cellspacing="2">
				...
				<tr>
            		<td class="font-field"  align="right" width="150">ประเภทวันทำงาน</td>
					<td colspan="3" >

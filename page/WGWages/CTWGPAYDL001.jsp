...
<html>
	<head>
		<title>บันทึกข้อมูลหลักในการจัดทำค่าจ้างลูกจ้างเหมา</title>
		<!-- Include -->
		...
		<script type="text/javascript">
		    ...
		    //alert( data.toJSONString() );
		    	...
		    	if( data.firstName != null )
		    	{
			    	...
			    	FeeWgPrEmployeeService.findPrEmployee('<%=ouCode%>', $("year").value, $("period").value, $("empCode").value, '<%=userId%>',{callback:whenPrEmployeeLoadCallback,errorHandler:function(message) { alert('เกิดข้อผิดพลาดเกี่ยวกับการติดต่อสื่อสารพพพ');}});
		    	}else
	...
	<body>
		<table width="100%">
			<tr>
				<td class="font-head">
					[ CTWGPAYDL001 ] ลบข้อมูลหลักลูกจ้างเหมาออกจากงานค่าจ้าง
				</td>
			</tr>
		</table>

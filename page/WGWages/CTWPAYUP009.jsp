...
<table width="100%">
	<tr>
		<td class="font-head">
			[ CTRWUP009 ] บันทึกรายการหักกรณีวินัย ตัดค่าจ้าง และขาดงาน
		</td>
	</tr>
</table>
				...
				<table id="table"  bordercolor="#4A4A4A" align="center" style="text-align: center;width:800px" border="1" cellpadding="0" cellspacing="0" >
					<thead style="text-align: center">
						<tr CLASS="TABLEBULE2">
							...
							<th CLASS="TABLEBULE2" style="width:250px" colspan="3" rowspan="1" align="center"><center>ตัดค่าจ้าง</center></th>

...
<table width="400" border="0" align="center" cellspacing="1">
	...
	<tr>
		...
		<td >
			<select widgetId="empCode" dojoType="combobox" style="width:135;">
          	</select>
		</td>
		<td colspan="2">
...
<script>	
	...
	function whenClickAdd(){
		...
		FeeWgPrWorkDayService.addPrWorkDay(ouCode, year, month, empCode, creby, arrDay, arrWorkCode, arrWorkSeq,arrNote, {callback:whenAddComplete});
	}

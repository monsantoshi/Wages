...
<table width="100%" >
<tr>
	<td height="70" align="left" valign="top"  class="font-head">[ CTWPAYBRSRP001 ]  รายงานรายชื่อลูกจ้างที่ไม่สามารถรับเงินผ่านธนาคาร ไทยพาณิชย์)</td>
</tr>
<tr>
<td align="center" valign="middle">
<form action="wpayPrBreakPayScbReport.htm?reqCode=doPrintReport" method="post" name="mainform"  >

...
<html>
<head>
<title>Report Other income OutAmt</title>
...
<script type="text/javascript">
	...
	function onLoadIncDec(){
		FeeWgPrIncomeDeductService.findIncDecCodeOutAmtRep(DWRUtil.getValue("ouCode"),2,{callback:onLoadIncDecCallback});
	}
...
<table width="100%" >
<tr>
	<td height="70" align="left" valign="top" class="font-head">[ CTWGPAYAPRP002 ]  รายงานข้อมูลรายหัก หลังคำนวน จ้างเหมา</td>
</tr>
<tr>
<td align="center" valign="middle">
<form action="wgpayAftProcess02Report.htm?reqCode=doPrintReport" method="post" name="mainform" target="_blank" >
				...
				<tr>
					<td height="150" align="center" valign="middle" >
 						<table width="350" align="center" border="0" cellpadding="2" cellspacing="2">
							...
							<tr>
            					<td class="font-field"  align="right" width="100">ประเภทรายการหัก</td>
								...
								<td height="30" colspan="3" >
									<select name="flag" style="width: 233">
											...
											<!-- 
											<option value="R">รายการหักเรียกคืน</option>
											<option value="B">ตกเบิกปรับปรุงรายการหัก</option>

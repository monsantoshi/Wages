...
<script type="text/javascript">
	...
	function onLoadIncDec(){
		FeeWpayPrIncomeDeductService.findIncDecCodeOutAmtRep(DWRUtil.getValue("ouCode"),2,{callback:onLoadIncDecCallback});
	}
...
<table width="100%" >
<tr>
	<td height="70" align="left" valign="top" class="font-head">[ CTWPAYAPRP002 ]  รายงานข้อมูลรายหัก หลังคำนวน</td>
</tr>
<tr>
<td align="center" valign="middle">
<form action="wpayAftProcess02Report.htm?reqCode=doPrintReport" method="post" name="mainform" target="_blank" >

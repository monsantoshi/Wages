...
<script type="text/javascript">
	...
	function onLoadIncDec(){
		FeeWpayPrIncomeDeductService.findIncDecCodeRep(DWRUtil.getValue("ouCode"),2,{callback:onLoadIncDecCallback});
	}
...
<table width="100%" >
<tr>
	<td height="70" align="left" valign="top" class="font-head">[ CTWPAYAPRPMT011 ]  รายงานรับรองข้อมูลรายหักอื่นๆ (ลูกจ้าง)</td>
</tr>
<tr>
<td align="center" valign="middle">
<form action="wpayApPr011Rpt.htm?reqCode=doPrintReport" method="post" name="mainform" target="_blank" >

...
<table width="100%" >
<tr>
<td class="font-head">[ CTWPAYRP004 ]  รายงานข้อมูลจำนวนวันทำงานในแต่ละเดือนของลูกจ้าง</td>
</tr>
<tr>  
<td>
<form action="wpayPr004Rpt.htm?reqCode=doPrintReport" method="post" name="mainform"  ><div style="height:400px;">

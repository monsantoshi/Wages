...
<html>
<head>
<title>ยืนยันการรับรองรายการเบิก</title>
<!-- Include -->
...
var statusConfirm = 'N';
	...
	function chkMainClose(){
				FeeWpayPrPeriodLineService.findPeriodLine('<%=ouCode%>',$("year").value,$("period").value , {callback:whenchkMainCloseCallback,errorHandler:function(message) { alert('เกิดข้อผิดพลาดเกี่ยวกับการติดต่อสื่อสาร6');}});
		    }
...
<table width="100%">
	<tr>
		<td class="font-head">
			[ CTWPAYAPMT013 ] ยืนยันรับรอง และคำนวณเงินจ้าง
		</td>
	</tr>
</table>
...
<tr>
	<td valign="top">
	<FIELDSET>
    		<LEGEND>รับรองรายการเงินได้/เงินหัก</LEGEND>
    		<br>

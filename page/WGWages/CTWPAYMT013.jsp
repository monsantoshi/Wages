...
<html>
<head>
<title>ยืนยันรายการหักได้รับค่าจ้างไม่เต็มเดือน</title>
<!-- Include -->
...
var statusConfirm = 'N';
	...
	function whenShowDataTable()
	{
		...
		DWRUtil.useLoadingMessage("Loading ...");
		//alert("test");
		FeeWpayPrEmployeeTextService.updateConfirmVinai2
		(
			'<%=userId%>',
			'<%=ouCode%>',
			DWRUtil.getValue("year"),
...
<table width="100%">
	<tr>
		<td class="font-head">
			[ CTWPAYMT013 ] ยืนยันรายการหักกรณีได้รับค่าจ้างไม่เต็มเดือน
		</td>
	</tr>
</table>
...
<tr>
	<td valign="top">
	<FIELDSET>
    		<LEGEND>รายการหักได้รับค่าจ้างไม่เต็มเดือน</LEGEND>
    		<br>

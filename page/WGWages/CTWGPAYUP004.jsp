...
<script>
	...
	function writeTextNotes(notes, workSeq,workCode){
		return "<div align='center'><input type='text' workSeq='" + workSeq + "' workCode='" + workCode + "' name ='notes' value='" + notes + "' style='width: 70px;text-align: right;' /></div>";
	}
	...
	var cellFuncs = [	
		...
		function(data) { return writeTextNotes(data.note, data.workSeq,data.workCode);}
	];

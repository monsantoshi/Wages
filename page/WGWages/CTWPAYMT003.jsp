...
<script type="text/javascript">
	...
	function countData(){
		...
		FeeWpayRwOvertimeService.findCountOverTimeByCriteria
		(
			'<%=userId%>',
			orgFromCbo,
			orgToCbo,
	...
	function whenShowDataTable()
	{
		...
		FeeWpayRwOvertimeService.findOverTimeByCriteria
		(
			'<%=userId%>',
			orgFromCbo,
			orgToCbo,
...
<table width="100%">
	<tr>
		<td class="font-head">
			[ CTWPAYMT003 ] บันทึกค่าล่วงเวลา/ค่าทำงานในวันหยุดพักผ่อน
		</td>
	</tr>
</table>
...
<form name="insertForm" action="security.htm?reqCode=CTWPAYIN003" method="post">
...
<form name="editForm" action="security.htm?reqCode=CTWPAYUP003" method="post">

...
<table width="100%" >
<tr>
	<td  height="70" align="left" valign="top" class="font-head">[ CTWPAYAPRPMT003 ] รายงานรับรองข้อมูลค่าล่วงเวลา/ค่าทำงานในวันหยุดพักผ่อน</td>
</tr>
<tr>
	<td height="150" align="center" valign="middle">

<form action="wpayApPr003Rpt.htm?reqCode=doPrintReport" method="post" name="mainform" target="_blank"  >

   ...
   function whenSelectDateFromOption()
		...
		tempYear=workYear.substring(2,workYear.length);
			...
			if(tempYearFrom == tempYearTo){
				if(tempYearTo != tempYear){
					alert("เืดือน/ปี ต้องเป็นปีเดียวกันกับ ประจำปี");
					return false;
				}
	...
	<body>
		...
		<table width="100%">
			...
			<table border="1" align="center" width="850px" cellspacing="1">
				<tr>
				...
				<tr>
					<td align="right" class="font-field">สัญญาสิ้นสุดปี&nbsp;</td>
					<td width="250px" ><input type="text" name="workYear" style="text-align: center;" value="<%=year%>" size="4" maxlength="4" onkeyup="if(isNaN(Number(this.value))) this.value = this.value.substring(0,this.value.length - 1);"  onChange="onChangeMonth(this.value);" /></td>
					
				</tr>
					<tr>
					<td class="font-field"  align="right">สิ้นสุดสัญญาเดือน/ปี&nbsp;</td>
				...
				<tr>
					...
					<td width="55px"><INPUT type="button" class="button" value="ค้นหา" onclick="onQuery(whenQueryCon());"></td>
				</tr>
			...
			<table style="width:850px"  border="1" bordercolor="#6699CC"  align="center"  cellpadding="2" cellspacing="0">
			<thead>
				<tr CLASS="TABLEBULE2">

				...
				if(empNull){
					...
					for(var i=0; i<tab.rows.length; i++){
						...
						if (approveF[i].value != '' && approveF[i].value != null){
							...
							rwHealth.approveFlag  = null;
						}
						
						rwHealth.approveBy = '<%=userId%>';
						rwHealth.approveDate = getDateFromFormat(sed,"dd/MM/yyyy");
...
<table  width="800" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		...
		<table id="table" width="750"  border="1" bordercolor="#6699CC" cellpadding="0" cellspacing="0">
			...
			<td id="periodWork" align="center" ><select name="periodWork" disabled="disabled" >
			...
			<td id="totalHour" ><input type="text"  name="totalHour"  readonly="readonly" maxlength="3" style="text-align:right;width:100%;" onkeyup="if(this.value < 0) this.value = '';if(isNaN(Number(this.value))) this.value = this.value.substring(0,this.value.length - 1);"/></td>

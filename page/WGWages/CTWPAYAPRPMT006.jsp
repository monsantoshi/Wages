...
<table width="100%">
<tr>
	<td height="70" align="left" valign="top" class="font-head">[ CTWPAYAPRPMT006 ]  รายงานรับรองเงินเพิ่มบำรุงสุขภาพ จำแนกตามแผนก (ลูกจ้าง)</td>
</tr>
<tr>
<td align="center" valign="middle">
<form action="wpayApPr006Rpt.htm?reqCode=doPrintReport" method="post" name="mainform"  >
				...
				<tr><td height="120" align="center" valign="middle" >
 					<table width="350" align="center" border="0" cellpadding="2" cellspacing="2">
						...
						<tr>
							...
							<td colspan="3" >
								<select name="type" style="width: 233">	

...
<script type="text/javascript">
	...
	function onLoadIncDec(){
		FeeWgPrIncomeDeductService.findIncDecCodeOutAmtRep(DWRUtil.getValue("ouCode"),1,{callback:onLoadIncDecCallback});
	}
...
<table width="100%" >
<tr>
	<td height="70" align="left" valign="top" class="font-head">[ CTWGPAYAPRP001 ]  รายงานข้อมูลรายได้ หลังคำนวน จ้างเหมา</td>
</tr>
<tr>
<td align="center" valign="middle">
<form action="wgpayAftProcess01Report.htm?reqCode=doPrintReport" method="post" name="mainform" target="_blank" >

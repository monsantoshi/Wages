...
<script type="text/javascript">
	...
	function writeButton(inname,emp,flag)
	{
	     if(<c:out value='${ConfirmSuUser}' /> || flag==0){
	       return "<div align='center'><input type='button' class='button' disabled = 'true' name = '"+inname+"' value='คลิกเพื่อยกเลิกอนุมัติ;' empId='"+emp+"' flag='"+flag+"' /></div>";
	     } else {
		return "<div align='center'><input type='button' class='button' name = '"+inname+"' value='คลิกเพื่อยกเลิกอนุมัติ' onclick='preEdit(this.empId,this.flag);' empId='"+emp+"' flag='"+flag+"' /></div>";
		}
	}
...
<table width="100%">
	<tr>
		<td class="font-head">
			[ CTWPAYAPMT001_N ] ตรวจสอบยืนยันข้อมูลอนุมัติรายการ 
		</td>
	</tr>
</table>
<table width="770" border="0" align="center" cellspacing="1">
  ...
  <tr>
    ...
    <td align="left"><SELECT  dojoType="ComboBox" widgetId="orgToCbo" style="width:200"></SELECT></td>
 	...
 	<tr>
    <td class="font-field" align="right">สถานะอนุมัติ&nbsp;</td>
...
<table width="770"  border="1" bordercolor="#6699CC"  align="center"  cellpadding="2" cellspacing="0">
	<thead>
		...
		<th CLASS="TABLEBULE2">หมายเลขโทรศัพท์</th>
		<th CLASS="TABLEBULE2">การอนุมัติ</th>
		<th CLASS="TABLEBULE2" width="270">การยกเลิกอนุมัติมีผลทำให้ต้องประมวลผลใหม่</th>
		<tr>
	</thead>
	<tbody id="dataTable">
	</tbody>

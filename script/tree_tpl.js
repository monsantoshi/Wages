var TREE_TPL = {
	...
	'icon_60' : 'images/tree/base.gif',   // root icon selected
	
	'icon_16' : 'images/tree/folder.gif', // node icon normal
	'icon_20' : 'images/tree/folder.gif', // node icon selected
	...
	'icon_4'  : 'images/tree/page.gif', // leaf icon selected
	
	'icon_2'  : 'images/tree/joinbottom.gif', // junction for leaf
	'icon_3'  : 'images/tree/join.gif',       // junction for last leaf
	'icon_19' : 'images/tree/plusbottom.gif', // junction for closed node
	'icon_18' : 'images/tree/plus.gif',       // junctioin for last closed node
	'icon_26' : 'images/tree/minus.gif',     // junctioin for last opended node
	'icon_27' : 'images/tree/minusbottom.gif'// junction for opened node	

 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class CTWPAYRP014Controller extends MultiActionController {
			...
			for (Iterator itt = empList.iterator(); itt.hasNext();) {
				...
				if (empList.size() == count) {
					...
					if (vo.getFlagPr().equals("N")){
						sheet1.addCell(new Label(5, row,"",normalCenterLastFormat));
					}else if(vo.getFlagPr().equals("A")){
						sheet1.addCell(new Label(5, row,"ปรับปรุงรายการหัก",normalCenterLastFormat));
					}
					...
					if (vo.getFlagPr().equals("N")){
							sheet1.addCell(new Label(5, row,"",normalCenterFormat));
					}else if(vo.getFlagPr().equals("A")){
							sheet1.addCell(new Label(5, row,"ปรับปรุงรายการหัก",normalCenterFormat));
					}

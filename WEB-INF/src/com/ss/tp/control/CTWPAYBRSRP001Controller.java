 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class CTWPAYBRSRP001Controller extends MultiActionController {
	...
	public ModelAndView doPrintReport(HttpServletRequest request,
		...
		List empList = this.getFeeWpayPrEmployeeService().feeWpayPrBreakPayScbReport(userId, ouCode,
				year, period);
		...
		response.setHeader("Content-Disposition",
				"attachment; filename=./page/report/CTWPAYBRSRP001.xls");
		InputStream in = this.getServletContext().getResourceAsStream(
				"/page/report/CTWPAYBRSRP001.xls");

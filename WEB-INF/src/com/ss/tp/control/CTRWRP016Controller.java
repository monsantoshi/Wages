 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class CTRWRP016Controller extends MultiActionController {
	...
	public ModelAndView doPrintReport(HttpServletRequest request,
		...
		// }
		//
		List empList = this.getRwIncDecOtherService().decOtherReport(userId,
		...
		response.setHeader("Content-Disposition",
				"attachment; filename=./page/report/CTRWRP016.xls");
		InputStream in = this.getServletContext().getResourceAsStream(
				"/page/report/CTRWRP016.xls");
		...
		sheet[0].addCell(new Label(0, 1,"โปรแกรม CTRWRP016                                                                                    รายงาน"+(tempInDecName.equals("")?incDecName.equals("")?"ประเภทรายหัก":incDecName:tempInDecName),HeadLeftFormat));
			...
			for (Iterator itt = empList.iterator(); itt.hasNext();) {
				...
				if (!tempInDecCode.equals(vo.getIncDecCode())) {
					if (!tempInDecCode.equals(vo.getIncDecCode())) {
						...
						sheet[j].addCell(new Label(0,1,"โปรแกรม CTRWRP016                                                                         รายงาน"+tempInDecName,HeadLeftFormat));

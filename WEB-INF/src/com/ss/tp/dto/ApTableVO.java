...
public class ApTableVO implements Serializable {
	private Long keySeq;
	...
	public ApTableVO(Long keySeq, String ouCode, Double yearPn, Double monthPn,
			String volumeSet, String empCode, String name, String oldPosition,
			String oldLevel, String oldPositionShort, Long codeSeq,
			String oldDuty, String newOldDuty, String newPositionCode,
			String newLevelCode, String newGworkCode, String newDuty,
			String newOrgCode, Long newCodeSeq, String newOrgDesc,
			String orgCode, String orgDesc, Double seqData, Double totAmt,
			String creBy, String updBy, Date creDate, Date updDate,
			String confirmFlag, String approveFlag, String transferFlag,
			String bankFlag, String approveBy, Date approveDate,
			String transferBy, Date transferDate, String bankBy, Date bankDate,
			String approveClose, String bankClose, String transferClose) {

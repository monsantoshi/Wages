...
public class PnEmpImpEngNameVO implements Serializable {
	...
	public String getEngEmpName() {
		return engEmpName;
	}

	public void setEngEmpName(String engEmpName) {
		this.engEmpName = engEmpName;
	}

...
public class FeeWpayPrEmployeeVO implements Serializable {
...
;
	...
	public FeeWpayPrEmployeeVO( String id, Double work,String flag,
			...
			String by2, Date date2, Double year,String bankBranch,String bankCode) {
		super();

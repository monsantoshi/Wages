...
public class FeeWpayRwOvertimeVO implements Serializable {
	private Long keySeq;
	...
	public FeeWpayRwOvertimeVO() {

	}

	public FeeWpayRwOvertimeVO(Double day1, Double day15, Double day3, Long seq,
			...
			Date date4, Double pr3, Double work3,Double workH,String appBy,Date appDate,String appFlag,String appClose,String ename) {

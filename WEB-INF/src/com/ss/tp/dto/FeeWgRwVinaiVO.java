...
public class FeeWgRwVinaiVO implements Serializable {
	private Long keySeq;
	...
	public FeeWgRwVinaiVO() {

	}

	public FeeWgRwVinaiVO(Double day1, Double day2, Double month1, Double month2,
			...
			Double work2,String appBy,Date appDate,String appFlag,String appClose) {

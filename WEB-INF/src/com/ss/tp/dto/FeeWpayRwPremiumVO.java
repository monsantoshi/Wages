...
public class FeeWpayRwPremiumVO implements Serializable {
	private Long keySeq;
	...
	public FeeWpayRwPremiumVO() {

	}

	public FeeWpayRwPremiumVO(Double day, Double hour, Double aft, Double evn,
			...
			String name,String appBy,Date appDate,String appFlag,String appClose) {

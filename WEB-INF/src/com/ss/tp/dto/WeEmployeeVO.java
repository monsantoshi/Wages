...
public class WeEmployeeVO implements Serializable {
	private Long keySeq;
	...
	public WeEmployeeVO(Long keySeq, String ouCode, Double yearPn,
			...
			Double seqData,Double totAmt,String approveFlag, String creBy, String updBy, Date creDate,
			Date updDate) {

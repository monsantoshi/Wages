...
public class RwPremiumEmployeeVO implements Serializable {
	private Long keySeq;
	...
	public RwPremiumEmployeeVO() {

	}

	public RwPremiumEmployeeVO(Double day, Double hour, Double aft, Double evn,
			Double mor, Long seq, String flag, String by, Date date,
			String code, String name, Double day2, Double hour2, String pr,
			Long seq2, Double day3, Double hour3, String code2, Double pr2,
			Double work, Double data, String by2, Date date2, Double pr3,
			Double work2,String appF,String orgDesc) {

...
public class PrEmployeeVO implements Serializable {
	...
	public PrEmployeeVO(Double newsal, Double oldsal, String id, Double study,
			Double study2, Double work, Double labour, String flag,
			Double child, Double life, String by, Date date, Double life2,
			Double loan, Double amt, Double donate, String code, String father,
			String spouse, String mother, String spouse2, String pr,
			Double amt2, String flag2, Double tax, Double ltf, String status,
			Double salary, Double salary2, Double other, String code2,
			Double overage, Double spouse3, String status2, Double fund,
			Double period, Double rmf, Double rec, String id2, Double fund2,
			String by2, Date date2, Double year, Double oldChev,
			Double newChev, String bankBranch, String bankCode,
			Double healthFather, Double handicappedDec, Double oldKc2000,
			Double newKc2000,Double life3) {
		super();

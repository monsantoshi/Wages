...
public class FeeWpayRwVinaiVO implements Serializable {
	private Long keySeq;
	...
	public FeeWpayRwVinaiVO() {

	}

	public FeeWpayRwVinaiVO(Double day1, Double day2, Double month1, Double month2,
			...
			Double work2,String appBy,Date appDate,String appFlag,String appClose,String name) {

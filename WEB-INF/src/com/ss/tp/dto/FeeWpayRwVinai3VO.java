...
public class FeeWpayRwVinai3VO implements Serializable {
	private Long keySeq;
	...
	public FeeWpayRwVinai3VO() {

	}

	public FeeWpayRwVinai3VO(Long seq, String flag, String by, Date date, Double day,
			String code, String pr, Long seq2, String code2, Double pr2,
			Double work, Double data, Double amt, String by2, Date date2,
			Double pr3, Double work2, String remark,String appBy,Date appDate,String appFlag,String appClose,String name)  {

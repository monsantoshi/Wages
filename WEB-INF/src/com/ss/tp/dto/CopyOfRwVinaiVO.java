...
public class CopyOfRwVinaiVO implements Serializable {
	private Long keySeq;
	...
	public CopyOfRwVinaiVO() {

	}

	public CopyOfRwVinaiVO(Double day1, Double day2, Double month1,
			Double month2, Double year1, Double year2, Long seq, String flag,
			String by, Date date, Double sal, Double month, Double sal2,
			Double newSal, Double month3, String code, Date qut, String pr,
			Long seq2, String code2, Double pr2, Double work, Double data,

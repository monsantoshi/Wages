...
public class PrEmployeeTextDAOImplBackUp extends HibernateDaoSupport implements
	...
	public List updateConfirmIncome(String userId, String ouCode, Long yearPr,
		...
		hql7.append(" from RwVinai rw, VPrEmployeeSecurity vpr , PrIncomeDeduct pr ");
		...
		hql8.append(" from RwVinai2 rw, VPrEmployeeSecurity vpr , PrIncomeDeduct pr ");
		...
		hql9.append(" from RwIncDecOther rw, VPrEmployeeSecurity vpr , PrIncomeDeduct pr ");

...
import com.ss.tp.dto.WgEmpDataStatusVO;
import com.ss.tp.model.WgEmpDataStatus;

public class WgEmpDataStatusDAOImpl extends HibernateDaoSupport implements
		WgEmpDataStatusDAO, Serializable {
	public List findByCriteria(String ouCode, String empCode, Date statusDate) {
		...
		for (Iterator iter = empList.iterator(); iter.hasNext();) {
			WgEmpDataStatus emp = (WgEmpDataStatus) iter.next();
			WgEmpDataStatusVO ret = new WgEmpDataStatusVO();
			try {

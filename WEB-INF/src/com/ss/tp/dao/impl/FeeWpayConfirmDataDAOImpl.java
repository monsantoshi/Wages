...
public class FeeWpayConfirmDataDAOImpl extends HibernateDaoSupport implements
		FeeWpayConfirmDataDAO, Serializable {
	public FeeWpayConfirmDataDAOImpl() {
	...
	public void insertWgConfirmData(FeeWpayConfirmDataVO vo) throws Exception {
		...
		try {
			...
			this.insertFlagMaster(vo.getUserId(),vo.getOuCode(),vo.getYear().toString() ,vo.getPeriod().toString());
	...
	public List addPnToPrB(String userId, String evaOuCode, String evaYear,String evaMonth) {
		...
		try {
			final Connection c = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:posttest", "hrpost","HRPOSTV1");
	...
	public List addFeeWpayDailyToGl(String userId, String evaOuCode, String evaYear,
		...
		int intYear = Integer.parseInt(evaYear.trim());
		int intMonth = Integer.parseInt(evaMonth.trim())*2;
	...
	public void insertFlagMaster(String userId, String evaOuCode, String evaYear,String evaPeriod) {
		...
		try {
			...
			final Connection c = DriverManager.getConnection(
					"jdbc:oracle:thin:@10.254.8.22:1521:post", "HRPOST",
					"HRPOSTV1");
			String plsql = "" + " begin " + "    FEE_WPAY_INSERT_FLAG1(?,?,?,?); "
					+ " end; ";

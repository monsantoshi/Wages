...
public class VFeeWpayRwVinaiDAOImpl extends HibernateDaoSupport implements
		VFeeWpayRwVinaiDAO, Serializable {
	...
	public List rwVinaiReport(String userId, String evaOuCode, Long evaYear,
		...
		hql.append(" rwV.totalDay,rwV.periodWork,rwV.decDay ,rwV.decSal,rwV.decSalMonth,rwV.cutSalPercent,rwV.flagPr ");
		hql.append(" from VFeeWpayRwVinai rwV ");
		...
		for (Iterator it = empList.iterator(); it.hasNext();) {
			...
			String flagPr = (String) r[17];

			VFeeWpayRwVinaiVO ret = new VFeeWpayRwVinaiVO();

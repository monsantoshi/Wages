...
public class FeeWpayRwPremiumReport implements Serializable {
	private Long keySeq;
	...
	public FeeWpayRwPremiumReport() {

	}

	public FeeWpayRwPremiumReport(Double day, Double hour, Double aft, Double evn,

...
public class PnEmpDataStatus implements Serializable {
	private PnEmpDataStatusPK pk;
	...
	public PnEmpDataStatus() {

	}

	public PnEmpDataStatus(PnEmpDataStatusPK pk, Date statusDate, Long hisSeq,
			...
			String gworkCode, String positionCode, Long positionSeq,
			Date positionDate, String levelCode, Date levelDate,
	...
	public PnEmpDataStatusPK getPk() {
		return pk;
	}

	public void setPk(PnEmpDataStatusPK pk) {
		this.pk = pk;
	}
	...
	public Long getPositionSeq() {
		return positionSeq;
	}

	public void setPositionSeq(Long positionSeq) {
		this.positionSeq = positionSeq;
	}

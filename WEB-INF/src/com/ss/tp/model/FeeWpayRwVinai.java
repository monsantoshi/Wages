...
public class FeeWpayRwVinai implements Serializable {
	private Long keySeq;
	...
	public FeeWpayRwVinai() {

	}

	public FeeWpayRwVinai(Long keySeq, String ouCode, Double yearPr,
			...
			Double seqData, String confirmFlag, String approveBy,
			Date approveDate, String approveFlag, String approveClose,

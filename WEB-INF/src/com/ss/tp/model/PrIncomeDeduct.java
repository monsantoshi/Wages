...
public class PrIncomeDeduct implements Serializable {
	private PrIncomeDeductPK pk;
	...
	public PrIncomeDeduct() {

	}

	public PrIncomeDeduct(String no, String by, Date date, Double seq,
			String inactive, String name, String nodel, PrIncomeDeductPK pk,
	...
	public PrIncomeDeductPK getPk() {
		return pk;
	}

	public void setPk(PrIncomeDeductPK pk) {
		this.pk = pk;
	}

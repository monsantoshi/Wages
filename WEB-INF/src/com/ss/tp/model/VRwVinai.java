...
public class VRwVinai implements Serializable {
	private VRwVinaiPK pk;
	...
	public VRwVinai(VRwVinaiPK pk, String empName, String orgDesc,
	...
	public VRwVinaiPK getPk() {
		return pk;
	}

	public void setPk(VRwVinaiPK pk) {
		this.pk = pk;
	}

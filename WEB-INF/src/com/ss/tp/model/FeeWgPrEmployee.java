...
public class FeeWgPrEmployee implements Serializable {
    private FeeWgPrEmployeePK key;
	...
	public FeeWgPrEmployee( String id,  Double work, String flag,
			Double child,  String by, Date date, String pr,
			String flag2, FeeWgPrEmployeePK key,
			String status, 
			 String status2,
	...
	public FeeWgPrEmployeePK getKey() {
		return key;
	}

	public void setKey(FeeWgPrEmployeePK key) {
		 this.key = key;
	}

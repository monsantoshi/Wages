...
public class FeeWgPrMonthlyLineComparator implements Comparable {
	...
	public int compareTo(Object prEmpSort) {
		...
		if (!(prEmpSort instanceof FeeWgPrMonthlyLineComparator))
			throw new ClassCastException(
					"A PrEmployeeTextForSort object expected.");
		int inDecCode = Integer.parseInt(((FeeWgPrMonthlyLineComparator) prEmpSort)
				.getIncDecCode());

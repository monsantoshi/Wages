...
public class FeeWpayPrIncomeDeduct implements Serializable {
	private FeeWpayPrIncomeDeductPK pk;
	...
	public FeeWpayPrIncomeDeduct() {

	}

	public FeeWpayPrIncomeDeduct(String no, String by, Date date, Double seq,
			String inactive, String name, String nodel, FeeWpayPrIncomeDeductPK pk,
	...
	public FeeWpayPrIncomeDeductPK getPk() {
		return pk;
	}

	public void setPk(FeeWpayPrIncomeDeductPK pk) {
		this.pk = pk;
	}

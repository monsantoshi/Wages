...
public class PrMonthlyLineComparator implements Comparable {
	...
	public int compareTo(Object prEmpSort) {
		...
		if (!(prEmpSort instanceof PrMonthlyLineComparator))
			throw new ClassCastException(
					"A PrEmployeeTextForSort object expected.");
		int inDecCode = Integer.parseInt(((PrMonthlyLineComparator) prEmpSort)
				.getIncDecCode());

...
public class FeeWgRwPremiumReport implements Serializable {
	private Long keySeq;
	...
	public FeeWgRwPremiumReport() {

	}

	public FeeWgRwPremiumReport(Double day, Double hour, Double aft, Double evn,

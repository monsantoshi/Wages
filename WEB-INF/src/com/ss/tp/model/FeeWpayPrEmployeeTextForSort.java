...
public class FeeWpayPrEmployeeTextForSort implements Comparable {
	...
	public int compareTo(Object prEmpSort) {
		...
		if (!(prEmpSort instanceof FeeWpayPrEmployeeTextForSort))
			throw new ClassCastException(
					"A PrEmployeeTextForSort object expected.");
		int inDecCode = Integer.parseInt(((FeeWpayPrEmployeeTextForSort) prEmpSort)
				.getInDecCode());

...
public class PeEmployeeScore implements Serializable {
	private PeEmpScorePK pk;
	...
	private Set peEmployeeScoreyDtl;

	public PeEmployeeScore() {
	...
	public PeEmployeeScore(PeEmpScorePK pk, Double evaTotal,
			Double scoreAdjust, Double scoreNet, String evaEmp1,
			String evaEmp2, String evaEmp3, PnEmployee emp,
			PnEmployee qevaEmp1, PnEmployee qevaEmp2, PnEmployee qevaEmp3,
			String pnTransfer, String creBy, Date creDate, String updBy,
			Date updDate, Date statusDate, Set peEmployeeScoreyDtl) {
		this.pk = pk;
		...
		this.statusDate = statusDate;
		this.peEmployeeScoreyDtl = peEmployeeScoreyDtl;
	}
	...
	public PeEmpScorePK getPk() {
		return pk;
	}

	public void setPk(PeEmpScorePK pk) {
		this.pk = pk;
	}
	...
	public Set getPeEmployeeScoreyDtl() {
		return peEmployeeScoreyDtl;
	}

	public void setPeEmployeeScoreyDtl(Set peEmployeeScoreyDtl) {
		this.peEmployeeScoreyDtl = peEmployeeScoreyDtl;
	}

 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class VWePnEmpText implements Serializable {
	private VWePnEmpTextPK vwePnEmpTextPK;
	...
	private Integer pnLevel;
	private String engName;
	private String engLastname;

	public VWePnEmpTextPK getVwePnEmpTextPK() {
		return vwePnEmpTextPK;
	}

	public void setVwePnEmpTextPK(VWePnEmpTextPK vwePnEmpTextPK) {
		this.vwePnEmpTextPK = vwePnEmpTextPK;
	}
	...
	public Integer getPnLevel() {
		return pnLevel;
	}

	public void setPnLevel(Integer pnLevel) {
		this.pnLevel = pnLevel;
	}

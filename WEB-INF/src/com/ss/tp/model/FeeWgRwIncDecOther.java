...
public class FeeWgRwIncDecOther implements Serializable {
	private Long keySeq;
	...
	public FeeWgRwIncDecOther() {

	}

	public FeeWgRwIncDecOther(Long seq, String flag, String by, Date date,
			String code, String pr, String code2, String code3, Long seq2,
			String code4, Double pr2, Double work, Double data, Double amt,
			String by2, Date date2, Double pr3, Double work2,String appBy,Date appDate,String appFlag,String appClose) {

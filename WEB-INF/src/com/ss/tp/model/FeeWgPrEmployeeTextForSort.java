...
public class FeeWgPrEmployeeTextForSort implements Comparable {
	...
	public int compareTo(Object prEmpSort) {
		...
		if (!(prEmpSort instanceof FeeWgPrEmployeeTextForSort))
			throw new ClassCastException(
					"A PrEmployeeTextForSort object expected.");
		int inDecCode = Integer.parseInt(((FeeWgPrEmployeeTextForSort) prEmpSort)
				.getInDecCode());
